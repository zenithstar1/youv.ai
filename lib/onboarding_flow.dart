        ...
        children: [
          ...
          Positioned.fill(
            ...
            child: RepaintBoundary(
              child: CustomPaint(
                painter: const _FaceMeshPainter(),
              ),
            ),
          ),
        ],
...
class _FaceMeshPainter extends CustomPainter {
  ...
  static const List<List<double>> _v = [
    ...
    [0.26, 0.16], [0.38, 0.15], [0.50, 0.15], [0.62, 0.15], [0.74, 0.16], // 4 - 8
    [0.22, 0.22], [0.33, 0.21], [0.42, 0.21], [0.50, 0.20], [0.58, 0.21], [0.67, 0.21], [0.78, 0.22], // 9 - 15
    [0.18, 0.29], [0.28, 0.28], [0.35, 0.27], [0.41, 0.28], [0.50, 0.28], [0.59, 0.28], [0.65, 0.27], [0.72, 0.28], [0.82, 0.29], // 16 - 24
    [0.17, 0.35], [0.28, 0.33], [0.35, 0.32], [0.42, 0.33], [0.50, 0.34], [0.58, 0.33], [0.65, 0.32], [0.72, 0.33], [0.83, 0.35], // 25 - 33
    [0.18, 0.42], [0.30, 0.40], [0.42, 0.40], [0.50, 0.41], [0.58, 0.40], [0.70, 0.40], [0.82, 0.42], // 34 - 40
    [0.20, 0.49], [0.32, 0.47], [0.42, 0.46], [0.50, 0.48], [0.58, 0.46], [0.68, 0.47], [0.80, 0.49], // 41 - 47
    [0.22, 0.56], [0.34, 0.54], [0.42, 0.53], [0.50, 0.52], [0.58, 0.53], [0.66, 0.54], [0.78, 0.56], // 48 - 54
    [0.24, 0.62], [0.36, 0.60], [0.43, 0.58], [0.50, 0.57], [0.57, 0.58], [0.64, 0.60], [0.76, 0.62], // 55 - 61
    [0.26, 0.68], [0.37, 0.66], [0.44, 0.64], [0.50, 0.65], [0.56, 0.64], [0.63, 0.66], [0.74, 0.68], // 62 - 68
    [0.30, 0.74], [0.40, 0.72], [0.50, 0.73], [0.60, 0.72], [0.70, 0.74], // 69 - 73
  ...
  static const List<List<int>> _edges = [
    ...
    [4, 5], [5, 6], [6, 7], [7, 8],
    [4, 9], [4, 10], [5, 10], [5, 11], [6, 11], [6, 12], [6, 13], [7, 13], [7, 14], [8, 14], [8, 15],
    [9, 10], [10, 11], [11, 12], [12, 13], [13, 14], [14, 15],
    [9, 16], [9, 17], [10, 17], [10, 18], [11, 18], [11, 19], [12, 19], [12, 20], [13, 20], [13, 21], [14, 21], [14, 22], [15, 22], [15, 23], [15, 24],
    [16, 17], [17, 18], [18, 19], [19, 20], [20, 21], [21, 22], [22, 23], [23, 24],
    [16, 25], [16, 26], [17, 26], [17, 27], [18, 27], [18, 28], [19, 28], [19, 29], [20, 29], [21, 29], [21, 30], [22, 30], [22, 31], [23, 31], [23, 32], [24, 32], [24, 33],
    [25, 26], [26, 27], [27, 28], [28, 29], [29, 30], [30, 31], [31, 32], [32, 33],
    [25, 34], [25, 35], [26, 35], [27, 35], [27, 36], [28, 36], [29, 36], [29, 37], [29, 38], [30, 38], [31, 38], [31, 39], [32, 39], [33, 39], [33, 40],
    [34, 35], [35, 36], [36, 37], [37, 38], [38, 39], [39, 40],
    [34, 41], [34, 42], [35, 42], [36, 42], [36, 43], [37, 43], [37, 44], [37, 45], [38, 45], [38, 46], [39, 46], [40, 46], [40, 47],
    [41, 42], [42, 43], [43, 44], [44, 45], [45, 46], [46, 47],
    [41, 48], [41, 49], [42, 49], [43, 49], [43, 50], [44, 50], [44, 51], [44, 52], [45, 52], [45, 53], [46, 53], [47, 53], [47, 54],
    [48, 49], [49, 50], [50, 51], [51, 52], [52, 53], [53, 54],
    [48, 55], [48, 56], [49, 56], [50, 56], [50, 57], [51, 57], [51, 58], [51, 59], [52, 59], [52, 60], [53, 60], [54, 60], [54, 61],
    [55, 56], [56, 57], [57, 58], [58, 59], [59, 60], [60, 61],
    [55, 62], [55, 63], [56, 63], [57, 63], [57, 64], [58, 64], [58, 65], [58, 66], [59, 66], [59, 67], [60, 67], [61, 67], [61, 68],
    [62, 63], [63, 64], [64, 65], [65, 66], [66, 67], [67, 68],
    [62, 69], [63, 69], [63, 70], [64, 70], [65, 70], [65, 71], [65, 72], [66, 72], [67, 72], [67, 73], [68, 73],
    [69, 70], [70, 71], [71, 72], [72, 73],
    [69, 74], [70, 74], [70, 75], [71, 75], [72, 75], [72, 76], [73, 76],
    [74, 75], [75, 76],
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final points = _v.map((v) => Offset(v[0] * w, v[1] * h)).toList(growable: false);
